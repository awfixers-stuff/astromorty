"""Pydantic configuration models for Astromorty.
...
class ExternalServices(BaseModel):
    ...
    REDIS_URL: Annotated[
        ...
        Field(
            default="",
            description="Redis connection URL (Upstash or other Redis-compatible service)",
            examples=[
                "redis://default:password@host:port",
                "rediss://default:password@host:port",
                "redis://default:password@upstash-redis-host:6379",
            ],
        ),
    ]
...
class SSHConfig(BaseModel):
    """SSH administration interface configuration."""

    enabled: Annotated[
        bool,
        Field(
            default=False,
            description="Enable SSH admin server",
            examples=[False, True],
        ),
    ]
    host: Annotated[
        ...
        Field(
            default="0.0.0.0",
            description="SSH server host address",
            examples=["0.0.0.0", "127.0.0.1", "10.0.0.1"],
        ),
    ]
    port: Annotated[
        int,
        Field(
            ...
            examples=[8022, 22, 2222],
        ),
    ]
    host_keys_dir: Annotated[
        str,
        Field(
            default="/etc/astromorty/ssh",
            description="Directory containing SSH host keys",
            examples=["/etc/astromorty/ssh", "./ssh_keys", "~/.astromorty/ssh"],
        ),
    ]
    ...
    login_timeout: Annotated[
        ...
        Field(
            default=300,
            description="SSH login timeout in seconds",
    ...
    session_timeout: Annotated[
        ...
        Field(
            default=1800,
            description="SSH session timeout in seconds (30 minutes)",
            examples=[1800, 3600, 7200],
        ),
    ]
    allowed_networks: Annotated[
        str,
        Field(
            default="",
            description="Comma-separated list of allowed IP/network ranges (empty = allow all)",
            examples=[
    ...
    rate_limit: Annotated[
        ...
        Field(
            default=10,
            description="Rate limit for SSH commands per minute",
            examples=[10, 20, 50],
        ),
    ]
    require_2fa: Annotated[
        bool,
        Field(
            default=False,
