"""
Custom Exceptions for Astromorty Bot.

This module defines all custom exception classes used throughout the Astromorty Discord bot,
...
if TYPE_CHECKING:
    from astromorty.database.models import Case
...
__all__ = [
    ...
    "AstromortyAppCommandPermissionLevelError",
    "AstromortyCodeExecutionError",
    "AstromortyCogLoadError",
    "AstromortyCompilationError",
    "AstromortyConfigurationError",
    "AstromortyDatabaseConnectionError",
    "AstromortyDatabaseError",
    "AstromortyDatabaseMigrationError",
    "AstromortyDatabaseQueryError",
    "AstromortyDependencyResolutionError",
    "AstromortyError",
    "AstromortyFileWatchError",
    "AstromortyGracefulShutdown",
    "AstromortyHotReloadConfigurationError",
    "AstromortyHotReloadError",
    "AstromortyInvalidCodeFormatError",
    "AstromortyMissingCodeError",
    "AstromortyModuleReloadError",
    "AstromortyPermissionDeniedError",
    "AstromortyPermissionError",
    "AstromortyPermissionLevelError",
    "AstromortyRuntimeError",
    "AstromortyServiceError",
    "AstromortySetupError",
    "AstromortyUnsupportedLanguageError",
    "handle_case_result",
...
class AstromortyError(Exception):
    """Base exception for all Astromorty-specific errors."""


class AstromortyConfigurationError(AstromortyError):
    """Raised when there's a configuration issue."""


class AstromortyRuntimeError(AstromortyError):
    """Raised when there's a runtime issue."""


class AstromortySetupError(AstromortyError):
    """Raised when bot setup fails."""


class AstromortyGracefulShutdown(AstromortyError):  # noqa: N818
...
class AstromortyDatabaseError(AstromortyError):
    """Base exception for database-related errors."""


class AstromortyDatabaseConnectionError(AstromortyDatabaseError):
...
class AstromortyDatabaseMigrationError(AstromortyDatabaseError):
    """Raised when database migration fails."""


class AstromortyDatabaseQueryError(AstromortyDatabaseError):
...
class AstromortyPermissionError(AstromortyError):
    """Base exception for permission-related errors."""


class AstromortyPermissionLevelError(AstromortyPermissionError):
...
class AstromortyAppCommandPermissionLevelError(AstromortyPermissionError):
...
class AstromortyPermissionDeniedError(AstromortyPermissionError):
...
class AstromortyAPIError(AstromortyError):
    """Base exception for API-related errors."""


class AstromortyAPIConnectionError(AstromortyAPIError):
...
class AstromortyAPIRequestError(AstromortyAPIError):
...
class AstromortyAPIResourceNotFoundError(AstromortyAPIRequestError):
...
class AstromortyAPIPermissionError(AstromortyAPIRequestError):
...
class AstromortyCodeExecutionError(AstromortyError):
    """Base exception for code execution errors."""


class AstromortyMissingCodeError(AstromortyCodeExecutionError):
...
class AstromortyInvalidCodeFormatError(AstromortyCodeExecutionError):
...
class AstromortyUnsupportedLanguageError(AstromortyCodeExecutionError):
...
class AstromortyCompilationError(AstromortyCodeExecutionError):
...
class AstromortyServiceError(AstromortyError):
    """Base exception for service-related errors."""


class AstromortyCogLoadError(AstromortyServiceError):
    """Raised when a cog fails to load."""


class AstromortyHotReloadError(AstromortyServiceError):
    """Base exception for hot reload errors."""


class AstromortyDependencyResolutionError(AstromortyHotReloadError):
    """Raised when dependency resolution fails."""


class AstromortyFileWatchError(AstromortyHotReloadError):
    """Raised when file watching fails."""


class AstromortyModuleReloadError(AstromortyHotReloadError):
    """Raised when module reloading fails."""


class AstromortyHotReloadConfigurationError(AstromortyHotReloadError):
...
def handle_case_result(case_result: Any) -> Any:
