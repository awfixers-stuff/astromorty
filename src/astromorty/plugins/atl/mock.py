"""
Mock Plugin for Astromorty Bot.
...
from astromorty.services.handlers.error.formatter import ERROR_CONFIG_MAP
...
class ErrorTestRegistry:
    ...
    def _build_test_registry(self) -> None:  # noqa: PLR0912, PLR0915
        ...
        for error_type in ERROR_CONFIG_MAP:
            ...
            elif name.startswith("Astromorty"):
...
class Mock(BaseCog):
    ...
    async def _send_test_summary(self, ctx: commands.Context[Astromorty]) -> None:
    ...
    async def mock(self, ctx: commands.Context[Astromorty]) -> None:
        """
    ...
    @requires_command_permission()
    async def mock_test(self, ctx: commands.Context[Astromorty], *, error_type: str) -> None:
        """
