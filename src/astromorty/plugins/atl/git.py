"""
Git Plugin for Astromorty Bot.

This plugin provides GitHub integration commands for repository management,
issue creation, and issue retrieval through the Astromorty Discord bot.
"""
...
from astromorty.services.wrappers.github import GithubService
from astromorty.shared.config import CONFIG
from astromorty.ui.buttons import GithubButton
...
class Git(BaseCog):
    ...
    async def git(self, ctx: commands.Context[Astromorty]) -> None:
        """
    ...
    @commands.guild_only()
    @requires_command_permission()
    async def get_repo(self, ctx: commands.Context[Astromorty]) -> None:
        """
    ...
    @commands.guild_only()
    @requires_command_permission()
    async def get_issue(self, ctx: commands.Context[Astromorty], issue_number: int) -> None:
        """
