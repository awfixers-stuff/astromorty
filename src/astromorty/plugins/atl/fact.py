"""
Fact Plugin for Astromorty Bot.
...
def _substitute_placeholders(bot: Astromorty, text: str) -> str:
...
class Fact(BaseCog):
    ...
    async def fact(self, ctx: commands.Context[Astromorty], fact_type: str = "random") -> None:
