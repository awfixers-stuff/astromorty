...
from astromorty.database.models.models import (
...
class PermissionSystem:
    ...
    def __init__(self, bot: Astromorty, db: DatabaseCoordinator) -> None:
        """
    ...
    async def get_user_permission_rank(self, ctx: commands.Context[Astromorty]) -> int:
        """
...
def init_permission_system(bot: Astromorty, db: DatabaseCoordinator) -> PermissionSystem:
    """
