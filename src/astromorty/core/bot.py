"""
Astromorty Discord bot core implementation.

This module defines the main Astromorty bot class, which extends discord.py's Bot
...
from astromorty.core.setup.orchestrator import BotSetupOrchestrator
from astromorty.core.task_monitor import TaskMonitor
from astromorty.database.controllers import DatabaseCoordinator
from astromorty.database.service import DatabaseService
from astromorty.services.emoji_manager import EmojiManager
...
from astromorty.shared.exceptions import AstromortyDatabaseConnectionError
from astromorty.shared.version import get_version
from astromorty.ui.banner import create_banner

__all__ = ["Astromorty"]


class Astromorty(commands.Bot):
    """
    Main bot class for Astromorty, extending discord.py's commands.Bot.
