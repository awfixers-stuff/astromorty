...
from astromorty.core.setup.base import BaseSetupService
...
class DatabaseSetupService(BaseSetupService):
    ...
    async def _upgrade_head_if_needed(self) -> None:
        ...
        def _run_migration_sync():
            try:
                ...
                raise AstromortyDatabaseMigrationError(error_msg) from e
        ...
        try:
            ...
            logger.exception(error_msg)
            raise AstromortyDatabaseMigrationError(error_msg) from e
        except AstromortyDatabaseMigrationError:
    ...
    async def setup(self) -> None:
        ...
        if not self.db_service.is_connected():
            ...
            raise AstromortyDatabaseConnectionError(msg)
        ...
        try:
            ...
            raise AstromortyDatabaseConnectionError(error_msg) from e
    ...
    async def _validate_schema(self) -> None:
        ...
        try:
            ...
            if schema_result["status"] == "valid":
                ...
                raise AstromortySetupError(msg)  # noqa: TRY301
