"""
Astromorty application entrypoint and lifecycle management.

This module provides the orchestration necessary to run Astromorty,
...
from astromorty.help import AstromortyHelp
from astromorty.services.sentry import SentryManager, capture_exception_safe
from astromorty.shared.config import CONFIG

if TYPE_CHECKING:
    from astromorty.core.bot import Astromorty

__all__ = ["AstromortyApp", "get_prefix"]


async def get_prefix(bot: "Astromorty", message: discord.Message) -> list[str]:
    """
...
class AstromortyApp:
    """
    Application wrapper for managing Astromorty bot lifecycle.
    ...
    def run(self) -> int:
        """
        Run the Astromorty bot application.
    ...
    async def start(self) -> int:
        """
        Start the Astromorty bot with full lifecycle management.
    ...
    def _create_bot_instance(self, owner_ids: set[int]) -> "Astromorty":
        """Create and configure the Astromorty bot instance."""
        from astromorty.core.bot import Astromorty  # noqa: PLC0415
