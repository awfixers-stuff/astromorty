...
from astromorty.core.converters import CaseTypeConverter, TimeConverter, convert_bool
from astromorty.database.models import CaseType
from astromorty.shared.constants import DEFAULT_REASON

__all__ = [
    # Base converter
    "AstromortyFlagConverter",
    # Moderation flags
    "BanFlags",
    "TempBanFlags",
    "UnbanFlags",
...
class AstromortyFlagConverter(commands.FlagConverter):
...
class BanFlags(AstromortyFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
...
class TempBanFlags(AstromortyFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
...
class UnbanFlags(AstromortyFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
    """Flags for unban commands."""


class KickFlags(AstromortyFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
...
class WarnFlags(AstromortyFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
...
class TimeoutFlags(AstromortyFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
...
class JailFlags(AstromortyFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
...
class UnjailFlags(AstromortyFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
...
class PollBanFlags(AstromortyFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
...
class TldrFlags(AstromortyFlagConverter, case_insensitive=True, delimiter=" ", prefix="-"):
