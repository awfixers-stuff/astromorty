...
ERROR_CONFIG_MAP: dict[type[Exception], ErrorHandlerConfig] = {
    ...
    # === Custom Errors ===
    AstromortyPermissionLevelError: ErrorHandlerConfig(
        message_format="You need permission level `{error.permission}`.",
        send_to_sentry=False,
    ),
    AstromortyAppCommandPermissionLevelError: ErrorHandlerConfig(
        message_format="You need permission level `{error.permission}`.",
        send_to_sentry=False,
    ),
    AstromortyPermissionDeniedError: ErrorHandlerConfig(
        message_format="{message}",
        detail_extractor=extract_permission_denied_details,
        send_to_sentry=False,
    ),
    AstromortyMissingCodeError: ErrorHandlerConfig(
        message_format="{error}",
        log_level="INFO",
        send_to_sentry=False,
    ),
    AstromortyInvalidCodeFormatError: ErrorHandlerConfig(
        message_format="{error}",
        log_level="INFO",
        send_to_sentry=False,
    ),
    AstromortyUnsupportedLanguageError: ErrorHandlerConfig(
        message_format="{error}",
        log_level="INFO",
        send_to_sentry=False,
    ),
    AstromortyCompilationError: ErrorHandlerConfig(
        message_format="{error}",
        log_level="INFO",
    ),
    AstromortyCodeExecutionError: ErrorHandlerConfig(
        message_format="{error}",
        log_level="INFO",
    ),
    # === HTTPX Errors ===
