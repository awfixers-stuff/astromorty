"""
Godbolt API Wrapper for Astromorty Bot.
...
from astromorty.shared.constants import HTTP_NOT_FOUND
...
async def sendresponse(url: str) -> str:
    ...
    try:
        ...
        raise AstromortyAPIConnectionError(service_name="Godbolt", original_error=e) from e
