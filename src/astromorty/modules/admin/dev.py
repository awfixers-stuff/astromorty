"""Development and administrative commands for the Astromorty bot.
...
class Dev(BaseCog):
    ...
    async def dev(self, ctx: commands.Context[Astromorty]) -> None:
        """
    ...
    @commands.guild_only()
    @requires_command_permission()
    async def sync_tree(self, ctx: commands.Context[Astromorty], guild: discord.Guild) -> None:
        """
    ...
    @commands.guild_only()
    @requires_command_permission()
    async def clear_tree(self, ctx: commands.Context[Astromorty]) -> None:
        """
    ...
    @commands.guild_only()
    @requires_command_permission()
    async def emoji(self, ctx: commands.Context[Astromorty]) -> None:
        """
    ...
    @commands.guild_only()
    @requires_command_permission()
    async def sync_emojis(self, ctx: commands.Context[Astromorty]) -> None:
        """
    ...
    @commands.guild_only()
    @requires_command_permission()
    async def resync_emoji(self, ctx: commands.Context[Astromorty], emoji_name: str) -> None:
        """
    ...
    @commands.guild_only()
    @requires_command_permission()
    async def delete_all_emojis(self, ctx: commands.Context[Astromorty]) -> None:
        """
    ...
    @commands.guild_only()
    @requires_command_permission()
    async def list_emojis(self, ctx: commands.Context[Astromorty]) -> None:
        """
    ...
    @commands.guild_only()
    @requires_command_permission()
    async def load_cog(self, ctx: commands.Context[Astromorty], *, cog: str) -> None:
        """
    ...
    @commands.guild_only()
    @requires_command_permission()
    async def unload_cog(self, ctx: commands.Context[Astromorty], *, cog: str) -> None:
        """
    ...
    @commands.guild_only()
    @requires_command_permission()
    async def reload_cog(self, ctx: commands.Context[Astromorty], *, cog: str) -> None:
        """
    ...
    @commands.guild_only()
    @requires_command_permission()
    async def stop(self, ctx: commands.Context[Astromorty]) -> None:
        """
        Stop the bot. If Astromorty is running with Docker Compose, this will restart the container.
        ...
        """
        await ctx.send(
            "Stopping the bot...\n-# Note: if Astromorty is running with Docker Compose, this will restart the container.",
        )
