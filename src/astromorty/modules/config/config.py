...
class Config(commands.Cog):
    ...
    async def config(self, ctx: commands.Context[Astromorty]) -> None:
    ...
    @commands.guild_only()
    @requires_command_permission()
    async def config_overview(self, ctx: commands.Context[Astromorty]) -> None:
    ...
    @commands.guild_only()
    @requires_command_permission()
    async def ranks_group(self, ctx: commands.Context[Astromorty]) -> None:
    ...
    @commands.guild_only()
    @requires_command_permission()
    async def ranks_init(self, ctx: commands.Context[Astromorty]) -> None:
    ...
    @commands.guild_only()
    @requires_command_permission()
    async def roles_group(self, ctx: commands.Context[Astromorty]) -> None:
    ...
    @commands.guild_only()
    @requires_command_permission()
    async def commands_group(self, ctx: commands.Context[Astromorty]) -> None:
    ...
    @commands.guild_only()
    @requires_command_permission()
    async def logs(self, ctx: commands.Context[Astromorty]) -> None:
