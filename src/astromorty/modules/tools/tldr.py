...
from astromorty.core.flags import TldrFlags
from astromorty.services.sentry import capture_exception_safe
from astromorty.services.wrappers.tldr import SUPPORTED_PLATFORMS, TldrClient
from astromorty.shared.functions import generate_usage
...
class Tldr(BaseCog):
    ...
    async def _handle_tldr_command(
        self,
        source: discord.Interaction | commands.Context[Astromorty],
        command_name: str,
        platform: str | None = None,
        language: str | None = None,
