"""
Moderation Module for Astromorty Bot.

This module provides the foundation for all moderation-related functionality
in the Astromorty Discord bot, including base classes for moderation cogs and
...
from astromorty.services.moderation import ModerationServiceFactory

if TYPE_CHECKING:
    from astromorty.services.moderation import ModerationCoordinator
