...
from astromorty.shared.functions import truncate
...
class Random(BaseCog):
    ...
    @commands.guild_only()
    async def coinflip(self, ctx: commands.Context[Astromorty]) -> None:
        """
        Flip a coin.
...
"""
    ...
    @commands.guild_only()
    async def dice(self, ctx: commands.Context[Astromorty], sides: int = 6) -> None:
        """
        Roll a dice.
