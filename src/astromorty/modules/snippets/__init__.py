...
from astromorty.core.permission_system import get_permission_system
from astromorty.database.models import CaseType as DBCaseType
from astromorty.database.models import Snippet
...
class SnippetsBaseCog(BaseCog):
    ...
    async def check_if_user_has_mod_override(self, ctx: commands.Context[Astromorty]) -> bool:
        """
