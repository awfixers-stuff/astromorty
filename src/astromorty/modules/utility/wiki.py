...
from astromorty.services.sentry import capture_api_error
...
class Wiki(BaseCog):
    ...
    async def wiki(self, ctx: commands.Context[Astromorty]) -> None:
        """
    ...
    async def arch_wiki(self, ctx: commands.Context[Astromorty], query: str) -> None:
        """
    ...
    async def atl_wiki(self, ctx: commands.Context[Astromorty], query: str) -> None:
        """
