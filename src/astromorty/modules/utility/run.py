...
class Run(BaseCog):
    ...
    async def run(self, ctx: commands.Context[Astromorty], *, code: str | None = None) -> None:
        """
        ...
        if not extracted_code:
            ...
            raise AstromortyMissingCodeError
        ...
        if not language or not source_code.strip():
            ...
            raise AstromortyInvalidCodeFormatError
        ...
        if not service:
            ...
            raise AstromortyUnsupportedLanguageError(language, SUPPORTED_LANGUAGES)
        ...
        if output is None:
            ...
            raise AstromortyCompilationError
    ...
    async def languages(self, ctx: commands.Context[Astromorty]) -> None:
        """
