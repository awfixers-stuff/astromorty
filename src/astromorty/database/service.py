"""
Database Service for Astromorty Bot.
...
from astromorty.services.sentry.metrics import record_database_metric
...
class DatabaseService:
    ...
    async def connect(self, database_url: str, **kwargs: Any) -> None:
        ...
        Supports standard PostgreSQL and Supabase connections.
        Supabase connections automatically include SSL requirements.
        ...
        database_url : str
            ...
            For Supabase: postgresql+psycopg://user:password@host:port/database?sslmode=require
        **kwargs : Any
    ...
    async def test_connection(self) -> None:
        ...
        try:
            ...
            from astromorty.services.sentry import capture_database_error  # noqa: PLC0415
