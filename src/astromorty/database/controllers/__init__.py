"""
Database Controllers for Astromorty Bot.
...
from astromorty.database.controllers.afk import AfkController
from astromorty.database.controllers.base import (
    BaseController as BaseController,
)  # Explicit re-export
from astromorty.database.controllers.case import CaseController
from astromorty.database.controllers.guild import GuildController
from astromorty.database.controllers.guild_config import GuildConfigController
from astromorty.database.controllers.levels import LevelsController
from astromorty.database.controllers.permissions import (
    PermissionAssignmentController,
    PermissionCommandController,
    PermissionRankController,
)
from astromorty.database.controllers.reminder import ReminderController
from astromorty.database.controllers.snippet import SnippetController
from astromorty.database.controllers.starboard import (
    StarboardController,
    StarboardMessageController,
)
from astromorty.database.controllers.ticket import TicketController
...
class DatabaseCoordinator:
    ...
    def __init__(self, db: DatabaseService | None = None) -> None:
        ...
        self._ticket: TicketController | None = None
    ...
    @property
    def ticket(self) -> TicketController:
        """Get the ticket controller."""
        if self._ticket is None:
            self._ticket = TicketController(self.db)
        return self._ticket
