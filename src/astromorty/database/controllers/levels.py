...
from astromorty.database.models import Levels
from astromorty.services.cache.decorators import cached, write_through_cache
...
class LevelsController(BaseController[Levels]):
    ...
    @cached("levels", ttl=get_strategy("levels").ttl)
    ...
    @write_through_cache("levels", ttl=get_strategy("levels").ttl)
